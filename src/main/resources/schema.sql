...
CREATE TABLE USERS(ID BIGINT PRIMARY KEY AUTO_INCREMENT, -- IDENTITY
...
CREATE TABLE COMMENTS(
                        ID BIGINT  NOT NULL AUTO_INCREMENT PRIMARY KEY , --IDENTITY
...
CREATE TABLE ITEMS(ID BIGINT PRIMARY KEY AUTO_INCREMENT, -- IDENTITY
